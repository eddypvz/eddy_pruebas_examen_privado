                            ...
                            <CCardBody v-if="token === ''">
                                ...
                                <div class="mb-3">
                                    <div class="text-muted mb-1">
                                        Recuperar contraseña a través de:
                                    </div>
                                    <select class="form-control" v-model="recuperarCon">
                                ...
                                <CInputGroup class="mb-3">
                                    ...
                                    <CFormInput
                                        :placeholder="(recuperarCon !== 'corporativo') ? 'Nombre de usuario o correo' : 'Corporativo'"
    ...
    methods: {
        ...
        send() {
            ...
            toolbox.doAjax('POST', 'auth/reset-password', {
                recuperarCon: self.recuperarCon,
        ...
        reset() {
            ...
            if (this.password !== this.passwordConfirm) {
                toolbox.alert('Las contraseñas no coinciden', 'danger');
            ...
            toolbox.doAjax('POST', 'auth/reset-my-password', {
                ...
                toolbox.alert(response.msg, 'error');
                self.loginProcess = false;
            })
        },
    }
