            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Escribe aquí" v-model="domain">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="mb-3">
                    ...
                    <div class="mt-5 text-end">
                        ...
                        <button @click="$router.push('/apps/listado')" class="btn btn-danger">Cancelar</button>
                    </div>
                </CCardBody>
            </CCard>
        </CCol>
...
export default {
    ...
    methods: {
            ...
            if (self.id > 0) {
                toolbox.doAjax('GET', 'apps/load/' + self.id, {},
                    function (responseRole) {
                        ...
                        self.domain = responseRole.data.domain;
        ...
        guardar() {
            ...
            data.append('domain', self.domain);
