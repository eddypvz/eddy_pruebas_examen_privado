...
<div class="wrapper clearfix" id="wrapperParallax">
    ...
    <header class="header header-transparent header-sticky">
        <nav class="navbar navbar-sticky navbar-expand-lg" id="primary-menu">
            <div class="container p-3"> <a class="logo navbar-brand" href="index.php">
                    <img class="logo logo-dark" src="assets/images/logo.png" alt="Municipalidad de Guatemala"/>
                    <img class="logo logo-light" src="assets/images/logo.png" alt="Municipalidad de Guatemala"/>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarContent">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item active"><a class="nav-link" href="#hero">Inicio</a></li>
                        <li class="nav-item"><a class="nav-link" href="https://www.muniguate.com/" target="_blank">Muni Portal</a></li>
